    ...
    ***************************************************************************** */
    ...
    var SukuModalService = /** @class */ (function () {
        function SukuModalService(dialogService) {
            ...
            this.onDialogCloseInterest = new i0.EventEmitter();
            this.onDialogCloseList = new i0.EventEmitter();
            this.onDialogClosePlaceBid = new i0.EventEmitter();
            this.onDialogCloseAcceptBid = new i0.EventEmitter();
            this.onDialogCloseSendPayment = new i0.EventEmitter();
            this.onDialogCloseDeleteList = new i0.EventEmitter();
            this.onDialogCloseCancelBid = new i0.EventEmitter();
            this.onDialogCloseUpdateInterest = new i0.EventEmitter();
