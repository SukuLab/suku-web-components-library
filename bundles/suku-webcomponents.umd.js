(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/elements'), require('rxjs'), require('@angular/common'), require('ngx-countdown-timer'), require('@angular/material'), require('@angular/material/dialog'), require('d3'), require('ngx-quill'), require('moment'), require('ng-pick-datetime'), require('@angular/forms'), require('@angular/core')) :
    typeof define === 'function' && define.amd ? define('suku-webcomponents', ['exports', '@angular/elements', 'rxjs', '@angular/common', 'ngx-countdown-timer', '@angular/material', '@angular/material/dialog', 'd3', 'ngx-quill', 'moment', 'ng-pick-datetime', '@angular/forms', '@angular/core'], factory) :
    (factory((global['suku-webcomponents'] = {}),global.ng.elements,global.rxjs,global.ng.common,global.ngxCountdownTimer,global.ng.material,global.ng.material.dialog,global.d3,global.ngxQuill,global._moment,global.ngPickDatetime,global.ng.forms,global.ng.core));
}(this, (function (exports,elements,rxjs,common,ngxCountdownTimer,material,i1,d3,ngxQuill,_moment,ngPickDatetime,forms,i0) { 'use strict';
